...
int ll_deleteLinkedList(LinkedList* this);//BORA LA LISTA
int ll_indexOf(LinkedList* this, void* pElement);//ME PASA EL INDEX DEL ELEMENTO QUE LE PASO
int ll_isEmpty(LinkedList* this);
int ll_push(LinkedList* this, int index, void* pElement);//CAMBIA UN EMPLEADO POR OTRO
void* ll_pop(LinkedList* this,int index);//METE UN EMPLEADO ENTRE OTROS
